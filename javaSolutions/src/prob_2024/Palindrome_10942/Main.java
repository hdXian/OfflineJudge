package prob_2024.Palindrome_10942;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=3; i<n+1; i++) {
            for(int j=1; j<=i-2; j++) {
                ...
                System.out.printf("checking arr[%d] == arr[%d] = %b\n", j, i, arr[j] == arr[i]);
                System.out.printf("checking table[%d][%d] = %b\n", j+1, i-1, table[j+1][i-1]);
