package ct_exercise.boj.move_people_16234;
...
//            System.out.println("print unite");
//            for(int row=0; row<N; row++) {
//                for(int col=0; col<N; col++) {
//                    System.out.print(unite[row][col] + " ");
//                }
//                System.out.println();
//            }
//            System.out.println("unite_count = " + unite_count);
            ...
            // 연합에 속한 국가의 row, col을 해당 연합 번호를 인덱스로 가진 List에 저장한다.
            for(int row=0; row<N; row++) {
                for(int col=0; col<N; col++) {
            ...
            // 각 연합을 순회하면서 해당 연합에 속하는 국가들의 인구를 나눔
            for(int i=0; i<unite_count; i++) {
...
//        System.setIn(new FileInputStream("res/input_boj_16234.txt"));
