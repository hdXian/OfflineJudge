package prob_202507.week1.bridge_17472;
...
public class Main {
    ...
    static class Edge implements Comparable<Edge> {
        ...
        public String toString() {
            return String.format("Edge[n1=%d, n2=%d, cost=%d]", n1, n2, cost);
        }
    }
...
//                if (board[row][col] != 0 && !lands.contains(board[row][col])) {
//                    lands.add(board[row][col]);
//                }
            }
            ...
            while(!lands.isEmpty()) {
                ...
                cost = idx2 - idx1;
                if (cost >= 2) {
                    System.out.printf("edge added in horizontal: n1=%d, n2=%d, idx1=%d, idx2=%d\n", n1, n2, idx1, idx2);
        ...
        for(int col=0; col<M; col++) {
            ...
            while(!lands.isEmpty()) {
                ...
                cost = idx2 - idx1;
                if (cost >= 2) {
                    System.out.printf("edge added in vertical: n1=%d, n2=%d, idx1=%d, idx2=%d\n", n1, n2, idx1, idx2);
                    edges.add(new Edge(n1, n2, cost));
                }

                System.out.printf("check vars: n1=%d, n2=%d, idx1=%d, idx2=%d\n", n1, n2, idx1, idx2);
    ...
    static int MST() {
        ...
        while(!pq.isEmpty() && edge_count < total_lands-1) {
            ...
            if (union(cur.n1, cur.n2)) {
                System.out.println(cur + " selected");
                edge_count++;
                total_cost += cur.cost;
            }
        }
