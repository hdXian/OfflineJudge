package prob_202504.week3.fillGas_1826;
...
//            int cost2 = s2.gas - s2.distance;
    ...
    public static int calc() throws Exception {
        ...
        while (true) {
            ...
            System.out.println("remain_distance = " + remain_distance);
            ...
            System.out.println("max_reachable = " + max_reachable);
            ...
            System.out.println("next.distance = " + next.distance);
            System.out.println("next.gas = " + next.gas);
