package prob_202502.week3.tree_4256;
...
public class Main {
    ...
    public static Node makeTree(List<Integer> preOrder, List<Integer> inOrder) {
        ...
        System.out.println("idx of root in inOrder = " + idx);
        ...
        System.out.println("leftTree_pre = " + leftTree_pre);
        System.out.println("leftTree_in = " + leftTree_in);

        System.out.println("rightTree_pre = " + rightTree_pre);
        System.out.println("rightTree_in = " + rightTree_in);
